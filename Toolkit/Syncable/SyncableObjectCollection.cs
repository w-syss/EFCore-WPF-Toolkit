...
{
    public class SyncableObjectCollection<T> : ObservableObject, ISyncableObjectCollection<T> where T : class, ISyncableObject
    {
        #region Fields
        ...
        public delegate bool SyncableCollectionSelectionHandler(T item, SelectionChangedEventArgs e);
        #endregion

        #region Constructor
        public SyncableObjectCollection(ObservableCollection<T> collection = null)
        {
